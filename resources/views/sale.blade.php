        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="alert alert-warning alert-dismissible">
                    ...
                    <br>
                    &nbsp;&nbsp;1.<b>กรณีที่จองล่วงหน้า 1 วัน</b> ระบบจะเปิดให้คอนเฟริ์มทันที แต่ระยะเวลาต้องไม่เกิน 17.30
                    น. *หากไม่คอนเฟริ์มระบบจะยกเลิกการจองอัตโนมัติ
                    <br>
                    &nbsp;&nbsp;2.<b>กรณีที่จองล่วงหน้า 2 วันขึ้นไป</b> ระบบจะเปิดให้กดคอนเฟริ์มก่อนวันที่นัดหมาย 1 วัน
                    ระยะเวลา 16.00-17.30 เท่านั้น *หากไม่คอนเฟริ์มระบบจะยกเลิกการจองอัตโนมัติ
                    <br>
                    - หากต้องการสอบถามรายละเอียด โปรดติดต่อเจ้าหน้าที่ <b><u>แอดมิน</u></b> 090-9896697 / 084-6757689
                </div>
                            ...
                            <tbody class="text-center">
                                ...
                                @foreach ($bookings as $booking)
                                    @php
                                        ...
                                        $startTime = '16:00:00';
                                        $endTime = '17:30:00';
                                        $oneDayBeforeBookingDate = date(
                                            'Y-m-d',
                                            strtotime($booking->booking_start . ' -1 day'),
                                        );
                                    ...
                                    <tr>
                                        ...
                                        <td class="project-actions text-center">
                                            ...
                                            @if ($booking->booking_status == 1)
                                                ...
                                                @if ($oneDaytomorrowBookingDate == $dateBookingTomorrow && $currentTime <= $endTime)
                                                ...
                                                @else
                                                    <button type="button" class="btn btn-default btn-sm"
                                                        ...
                                                        title="ขณะนี้ยังไม่เปิดให้คอนเฟริ์ม จะเปิดให้คอนเฟริ์มในวันที่ {{ $confirmBtn }} 16:00-17:30">
                                                        <i class="fa fa-check">
                                                        </i>
                                                        คอนเฟริ์มนัด
                                                    </button>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    @if ($booking->job_detailsubmission != null && $booking->job_img != null)
                                        <h4><u>รายละเอียดลูกค้าเข้าชม</u></h4>
